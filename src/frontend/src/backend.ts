...
export class Backend implements backendInterface {
    ...
    async getAllRoutes(): Promise<Array<BusRoute>> {
        if (this.processError) {
            try {
    ...
    async searchRoutes(arg0: string, arg1: string): Promise<Array<BusRoute>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchRoutes(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
